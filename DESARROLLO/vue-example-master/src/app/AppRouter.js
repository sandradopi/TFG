...
const routes = [
  ...
  { name: 'FutbolForm', path: '/games/:id/futbol/completeResultado/:intento', component: FutbolForm,meta: { authority: 'USER' }},
  { name: 'TennisForm', path: '/games/:id/tennis/completeResultado/:intento', component: TennisForm,meta: { authority: 'USER' }},
